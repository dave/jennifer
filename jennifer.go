...
//go:generate go install github.com/dave/jennifer/genjen
//go:generate genjen
//go:generate go install github.com/dave/jennifer/gennames
//go:generate gennames -output "jen/hints.go" -package "jen" -name "standardLibraryHints" -standard -novendor -path "./..."
//go:generate go install github.com/dave/rebecca/cmd/becca
