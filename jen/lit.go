...
// LitFunc renders a simple literal. LitFunc generates the value to render by executing the 
// provided function. The function must return bool, string, int, complex128, float64, float32, 
// int8, int16, int32, int64, uint, uint8, uint16, uint32, uint64, uintptr or complex64. Any other 
// type will cause a panic.
